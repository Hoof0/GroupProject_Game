...
int main() {
    ...
    interrogateAlexCoffee->setDescription("When you approached Alex's seat, you heard Alex telling Clara that his coffee was drugged. When Clara left, you asked Alex to check his drinks and got his permission.");
