...
int main() {
    ...
    sideEnding->setDescription("The plane lands hours later. Police arrest Aurora Antonae—framed by Mika via planted evidence. Headlines scream: “NOVATECH CEO MURDERED BY DISGRUNTLED FLIGHT ATTENDANT.”\n\nHoof Kaslei:\n(sipping a tropical drink on a beach, scrolling past the news) “Huh. Guess rich guys do have enemies. …Wait, was that the lady with the scar? Whatever.”");
